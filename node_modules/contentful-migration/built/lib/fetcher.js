...
class Fetcher {
    ...
    async fetchAllPaginatedItems(url, params = {}) {
        ...
        let skip = 0;
        while (true) {
            const paramsWithSkip = Object.assign(Object.assign({ limit: Fetcher.perRequestLimit, order: 'sys.createdAt' }, params), { skip: skip.toString(10) });
            let urlParams = '';
