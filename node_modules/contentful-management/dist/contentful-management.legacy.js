...
function createClient(params) {
  ...
  var userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_2__["getUserAgentHeader"])('contentful-management.js/' + '5.21.1', params.application, params.integration, params.feature);
...
function createOrganizationApi(_ref) {
  ...
  var _entities$teamMembers = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].teamMembership,
  ...
  var wrapOrganizationInvitation = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].organizationInvitation.wrapOrganizationInvitation;


  var teamAlphaHeaders = { 'x-contentful-enable-alpha-feature': 'teams-api' };
  ...
  function createTeamMembership(teamId) {
    ...
    return http.post('teams/' + teamId + '/team_memberships', data, { headers: teamAlphaHeaders }).then(function (response) {
      return wrapTeamMembership(http, response.data, teamId);
    }, _error_handler__WEBPACK_IMPORTED_MODULE_1__["default"]);
  }
  ...
  function getTeamMembership(teamId, teamMembershipId) {
    return http.get('teams/' + teamId + '/team_memberships/' + teamMembershipId, { headers: teamAlphaHeaders }).then(function (response) {
      return wrapTeamMembership(http, response.data, teamId);
    }, _error_handler__WEBPACK_IMPORTED_MODULE_1__["default"]);
  }
  ...
  function getTeamMemberships(teamId) {
    ...
    return http.get('teams/' + teamId + '/team_memberships', { headers: teamAlphaHeaders, query: query }).then(function (response) {
      return wrapTeamMembershipCollection(http, response.data, teamId);
    }, _error_handler__WEBPACK_IMPORTED_MODULE_1__["default"]);
  }
...
/* harmony import */ var _organization_membership__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./organization-membership */ "./entities/organization-membership.js");
/* harmony import */ var _organization_invitation__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./organization-invitation */ "./entities/organization-invitation.js");
/* harmony import */ var _role__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./role */ "./entities/role.js");
/* harmony import */ var _api_key__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./api-key */ "./entities/api-key.js");
/* harmony import */ var _preview_api_key__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./preview-api-key */ "./entities/preview-api-key.js");
/* harmony import */ var _upload__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./upload */ "./entities/upload.js");
/* harmony import */ var _organization__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./organization */ "./entities/organization.js");
/* harmony import */ var _ui_extension__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./ui-extension */ "./entities/ui-extension.js");
/* harmony import */ var _app_installation__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./app-installation */ "./entities/app-installation.js");
/* harmony import */ var _snapshot__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./snapshot */ "./entities/snapshot.js");
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./user */ "./entities/user.js");
/* harmony import */ var _personal_access_token__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./personal-access-token */ "./entities/personal-access-token.js");
/* harmony import */ var _usage__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./usage */ "./entities/usage.js");
/* harmony import */ var _environment_alias__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./environment-alias */ "./entities/environment-alias.js");
/* harmony import */ var _team_membership__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./team-membership */ "./entities/team-membership.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  organizationMembership: _organization_membership__WEBPACK_IMPORTED_MODULE_11__,
  organizationInvitation: _organization_invitation__WEBPACK_IMPORTED_MODULE_12__,
  role: _role__WEBPACK_IMPORTED_MODULE_13__,
  apiKey: _api_key__WEBPACK_IMPORTED_MODULE_14__,
  previewApiKey: _preview_api_key__WEBPACK_IMPORTED_MODULE_15__,
  upload: _upload__WEBPACK_IMPORTED_MODULE_16__,
  organization: _organization__WEBPACK_IMPORTED_MODULE_17__,
  uiExtension: _ui_extension__WEBPACK_IMPORTED_MODULE_18__,
  appInstallation: _app_installation__WEBPACK_IMPORTED_MODULE_19__,
  snapshot: _snapshot__WEBPACK_IMPORTED_MODULE_20__,
  user: _user__WEBPACK_IMPORTED_MODULE_21__,
  personalAccessToken: _personal_access_token__WEBPACK_IMPORTED_MODULE_22__,
  usage: _usage__WEBPACK_IMPORTED_MODULE_23__,
  environmentAlias: _environment_alias__WEBPACK_IMPORTED_MODULE_24__,
  teamMembership: _team_membership__WEBPACK_IMPORTED_MODULE_25__
});
...
function createTeamMembershipApi(http, teamId) {
  return {
    ...
    delete: function _delete() {
      return http.delete('teams/' + teamId + '/team_memberships/' + this.sys.id, { headers: { 'x-contentful-enable-alpha-feature': 'teams-api' } }).then(function (response) {}, _error_handler__WEBPACK_IMPORTED_MODULE_3__["default"]);
    }
  };
}
/**
 ...
 */
function wrapTeamMembership(http, data, teamId) {
  ...
  Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(teamMembership, createTeamMembershipApi(http, teamId));
 ...
 */
function wrapTeamMembershipCollection(http, data, teamId) {
  ...
  teamMemberships.items = teamMemberships.items.map(function (entity) {
    return wrapTeamMembership(http, entity, teamId);
  });
