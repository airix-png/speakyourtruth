  ...
  return (
    <Section narrow>
      <SubscriptionContainer>
        <Content>
          <Heading>A Note From PNG x YONKO Productions</Heading>
          <Text>
            Our mission is to amplify voices and serve as a guide to sources of credible information.
            We hope to hear from you!  
            <br/> <br/>
            If you have something you would like to share, check out <a href="https://forms.gle/WbpSWDX6LUB5g8q89" target="_blank">our form here.</a>
            <br /> <br />
            Also, keep up with us, by subscribing below. 
          </Text>
